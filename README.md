...
## CLion with Junie Pro (beta) plugin
...
It says that it added it to description of weapons, but it added it only to distance weapons and to armors, not other weapons and for sure not to all items.
